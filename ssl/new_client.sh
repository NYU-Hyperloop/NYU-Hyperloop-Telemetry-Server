...
openssl x509 -req -in client.req -CA server/ca.cer -CAkey server/ca.key -CAcreateserial -CAserial herong.seq -extensions client -days 365 -outform PEM -out client.cer
